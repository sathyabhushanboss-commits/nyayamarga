...
export default function CaseStudyPage() {
  ...
  const selectedCase = caseStudiesData[id as keyof typeof caseStudiesData];
      ...
      <>
        ...
        <main className="min-h-screen bg-gradient-to-br from-[#1a0808] via-[#2b0b0b] to-[#1a0808] text-white pt-32 pb-20">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-[#d4af37]">Case Study Not Found</h1>
            <Link href="/success-stories">
              <button className="mt-6 bg-[#d4af37] text-black px-6 py-3 rounded-md">
